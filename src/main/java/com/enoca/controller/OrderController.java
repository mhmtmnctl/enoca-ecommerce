...
public class OrderController {
	...
	//get order with date parameter
	
	@GetMapping("/date")
	public ResponseEntity<List<OrderResponseDTO>> getOrdersWithDate(@RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date){//ön taraftan gelen tarih bilgisini localDate türüne çevirdim
		
		List<OrderResponseDTO> orderListDTO= orderService.getOrdersWithDate(date);
